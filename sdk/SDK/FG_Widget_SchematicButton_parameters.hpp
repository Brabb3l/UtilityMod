...
#include "FG_Widget_SchematicButton_classes.hpp"
...
struct UWidget_SchematicButton_C_GetActivateButtonVisibility_Params
{
	ESlateVisibility                                   ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UWidget_SchematicButton_C_GetSchematicActivatedBorderVisibility_Params
{
	ESlateVisibility                                   ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Widget_SchematicButton.Widget_SchematicButton_C.GetSchematicBoughtTextColor
struct UWidget_SchematicButton_C_GetSchematicBoughtTextColor_Params
{
...
struct UWidget_SchematicButton_C_GetSchematicBoughtCheckImageFeedback_Params
{
	ESlateVisibility                                   ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Widget_SchematicButton.Widget_SchematicButton_C.GetActivatedText
struct UWidget_SchematicButton_C_GetActivatedText_Params
{
	struct FText                                       ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};

// Function Widget_SchematicButton.Widget_SchematicButton_C.GetSchematicName
struct UWidget_SchematicButton_C_GetSchematicName_Params
{
	struct FText                                       ReturnValue;                                              // (Parm, OutParm, ReturnParm)
};
