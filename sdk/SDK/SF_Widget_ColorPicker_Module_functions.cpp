...
#include "SF_Widget_ColorPicker_Module_parameters.hpp"
...
// Function Widget_ColorPicker_Module.Widget_ColorPicker_Module_C.SetColorAndSliders
// ()
// Parameters:
// struct FLinearColor            Color                          (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData)

void UWidget_ColorPicker_Module_C::SetColorAndSliders(const struct FLinearColor& Color)
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_ColorPicker_Module.Widget_ColorPicker_Module_C.SetColorAndSliders");

	UWidget_ColorPicker_Module_C_SetColorAndSliders_Params params;
	params.Color = Color;
