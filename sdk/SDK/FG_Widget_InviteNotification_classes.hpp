...
#include "FG_Widget_InviteNotification_structs.hpp"
...
// WidgetBlueprintGeneratedClass Widget_InviteNotification.Widget_InviteNotification_C
// 0x0038 (0x0240 - 0x0208)
class UWidget_InviteNotification_C : public UUserWidget
{
public:
	...
	class UTextBlock*                                  mPlayerName;                                              // 0x0230(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Widget_InviteNotification.Widget_InviteNotification_C");
		return ptr;
	}


	void Construct();
	void OnInviteReceived(const struct FPendingInvite& receivedInvite);
	void ExecuteUbergraph_Widget_InviteNotification(int EntryPoint);
};
