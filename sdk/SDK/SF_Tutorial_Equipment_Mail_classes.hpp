...
#include "SF_Tutorial_Equipment_Mail_structs.hpp"
...
// WidgetBlueprintGeneratedClass Tutorial_Equipment_Mail.Tutorial_Equipment_Mail_C
// 0x0028 (0x0288 - 0x0260)
class UTutorial_Equipment_Mail_C : public UFGMessageBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tutorial_Equipment_Mail.Tutorial_Equipment_Mail_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_Tutorial_Equipment_Mail(int EntryPoint);
};
