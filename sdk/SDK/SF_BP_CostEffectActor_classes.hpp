...
#include "SF_BP_CostEffectActor_structs.hpp"
...
public:
	...
	struct FVector                                     mTargetLocation;                                          // 0x0348(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	...
	struct FRotator                                    mRotationRate;                                            // 0x0360(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector                                     mArcOffset;                                               // 0x0384(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
