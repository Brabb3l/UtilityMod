...
#include "SF_BP_WheeledVehicle_parameters.hpp"
...
// Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassRepresentationType
// ()
// Parameters:
// ECompassRepresentationType     ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

ECompassRepresentationType ABP_WheeledVehicle_C::GetActorCompassRepresentationType()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassRepresentationType");

	ABP_WheeledVehicle_C_GetActorCompassRepresentationType_Params params;
...
// Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassColor
// ()
// Parameters:
// struct FLinearColor            ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FLinearColor ABP_WheeledVehicle_C::GetActorCompassColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassColor");

	ABP_WheeledVehicle_C_GetActorCompassColor_Params params;
...
// Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassText
// ()
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)

struct FText ABP_WheeledVehicle_C::GetActorCompassText()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassText");

	ABP_WheeledVehicle_C_GetActorCompassText_Params params;
...
// Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassTexture
// ()
// Parameters:
// class UTexture2D*              ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class UTexture2D* ABP_WheeledVehicle_C::GetActorCompassTexture()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorCompassTexture");

	ABP_WheeledVehicle_C_GetActorCompassTexture_Params params;
...
// Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorShouldShowInComapss
// ()
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool ABP_WheeledVehicle_C::GetActorShouldShowInComapss()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WheeledVehicle.BP_WheeledVehicle_C.GetActorShouldShowInComapss");

	ABP_WheeledVehicle_C_GetActorShouldShowInComapss_Params params;
