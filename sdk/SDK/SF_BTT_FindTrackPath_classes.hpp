...
#include "SF_BTT_FindTrackPath_structs.hpp"
...
public:
	...
	void FindPath(int Train, class AFGBuildableRailroadStation* Stop, bool* Success, struct FRailroadPathFindingResult* Result, class AFGLocomotive** Locomotive);
