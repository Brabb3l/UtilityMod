...
#include "SF_BTT_RandomLocation_structs.hpp"
...
public:
	...
	struct FVector                                     mCenterLocation;                                          // 0x0100(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     mTestLocation;                                            // 0x010C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
