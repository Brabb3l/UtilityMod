...
#include "SF_BP_SpitterProjectileSingle_structs.hpp"
...
public:
	...
	float                                              Gravity_Scale_over_Time_Gravity_Scale_02A6598A4993DE75B793A890687A4F4F;// 0x03B0(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Gravity_Scale_over_Time__Direction_02A6598A4993DE75B793A890687A4F4F;// 0x03B4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03B5(0x0003) MISSED OFFSET
	class UTimelineComponent*                          Gravity_Scale_over_Time;                                  // 0x03B8(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
