...
#include "SF_Anim_Jetpack_parameters.hpp"
...
void UAnim_Jetpack_C::BlueprintUpdateAnimation(float* DeltaTimeX)
{
	static auto fn = UObject::FindObject<UFunction>("Function Anim_Jetpack.Anim_Jetpack_C.BlueprintUpdateAnimation");

	UAnim_Jetpack_C_BlueprintUpdateAnimation_Params params;
...
void UAnim_Jetpack_C::ExecuteUbergraph_Anim_Jetpack(int EntryPoint)
{
	...
	UAnim_Jetpack_C_ExecuteUbergraph_Anim_Jetpack_Params params;
