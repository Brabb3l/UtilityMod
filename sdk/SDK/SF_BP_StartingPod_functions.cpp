...
#include "SF_BP_StartingPod_parameters.hpp"
...
// Function BP_StartingPod.BP_StartingPod_C.GetActorCompassRepresentationType
// ()
// Parameters:
// ECompassRepresentationType     ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

ECompassRepresentationType ABP_StartingPod_C::GetActorCompassRepresentationType()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_StartingPod.BP_StartingPod_C.GetActorCompassRepresentationType");

	ABP_StartingPod_C_GetActorCompassRepresentationType_Params params;
...
// Function BP_StartingPod.BP_StartingPod_C.GetActorCompassColor
// ()
// Parameters:
// struct FLinearColor            ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FLinearColor ABP_StartingPod_C::GetActorCompassColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_StartingPod.BP_StartingPod_C.GetActorCompassColor");

	ABP_StartingPod_C_GetActorCompassColor_Params params;
...
// Function BP_StartingPod.BP_StartingPod_C.GetActorCompassText
// ()
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)

struct FText ABP_StartingPod_C::GetActorCompassText()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_StartingPod.BP_StartingPod_C.GetActorCompassText");

	ABP_StartingPod_C_GetActorCompassText_Params params;
...
// Function BP_StartingPod.BP_StartingPod_C.GetActorCompassTexture
// ()
// Parameters:
// class UTexture2D*              ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

class UTexture2D* ABP_StartingPod_C::GetActorCompassTexture()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_StartingPod.BP_StartingPod_C.GetActorCompassTexture");

	ABP_StartingPod_C_GetActorCompassTexture_Params params;
...
// Function BP_StartingPod.BP_StartingPod_C.GetActorShouldShowInComapss
// ()
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool ABP_StartingPod_C::GetActorShouldShowInComapss()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_StartingPod.BP_StartingPod_C.GetActorShouldShowInComapss");

	ABP_StartingPod_C_GetActorShouldShowInComapss_Params params;
