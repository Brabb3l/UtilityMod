...
#include "SF_Widget_ImageTabButton_parameters.hpp"
...
// Function Widget_ImageTabButton.Widget_ImageTabButton_C.Get_activebackground_ColorAndOpacity_1
// ()
// Parameters:
// struct FLinearColor            ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FLinearColor UWidget_ImageTabButton_C::Get_activebackground_ColorAndOpacity_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_ImageTabButton.Widget_ImageTabButton_C.Get_activebackground_ColorAndOpacity_1");

	UWidget_ImageTabButton_C_Get_activebackground_ColorAndOpacity_1_Params params;
...
// Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetActiveButtonBackgroundVisibility
// ()
// Parameters:
// ESlateVisibility               ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

ESlateVisibility UWidget_ImageTabButton_C::GetActiveButtonBackgroundVisibility()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetActiveButtonBackgroundVisibility");

	UWidget_ImageTabButton_C_GetActiveButtonBackgroundVisibility_Params params;
...
// Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetTextColor
// ()
// Parameters:
// struct FSlateColor             ReturnValue                    (Parm, OutParm, ReturnParm)

struct FSlateColor UWidget_ImageTabButton_C::GetTextColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetTextColor");

	UWidget_ImageTabButton_C_GetTextColor_Params params;
...
// Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetIconColor
// ()
// Parameters:
// struct FLinearColor            ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FLinearColor UWidget_ImageTabButton_C::GetIconColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetIconColor");

	UWidget_ImageTabButton_C_GetIconColor_Params params;
...
// Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetImageBrush
// ()
// Parameters:
// struct FSlateBrush             ReturnValue                    (Parm, OutParm, ReturnParm)

struct FSlateBrush UWidget_ImageTabButton_C::GetImageBrush()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_ImageTabButton.Widget_ImageTabButton_C.GetImageBrush");

	UWidget_ImageTabButton_C_GetImageBrush_Params params;
