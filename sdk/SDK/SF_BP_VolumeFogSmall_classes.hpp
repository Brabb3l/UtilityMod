...
#include "SF_BP_VolumeFogSmall_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_VolumeFogSmall.BP_VolumeFogSmall_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_VolumeFogSmall(int EntryPoint);
};
