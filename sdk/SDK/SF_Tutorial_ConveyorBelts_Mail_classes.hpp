...
#include "SF_Tutorial_ConveyorBelts_Mail_structs.hpp"
...
// WidgetBlueprintGeneratedClass Tutorial_ConveyorBelts_Mail.Tutorial_ConveyorBelts_Mail_C
// 0x0028 (0x0288 - 0x0260)
class UTutorial_ConveyorBelts_Mail_C : public UFGMessageBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tutorial_ConveyorBelts_Mail.Tutorial_ConveyorBelts_Mail_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_Tutorial_ConveyorBelts_Mail(int EntryPoint);
};
