...
#include "SF_Widget_ColorPicker_Module_structs.hpp"
...
public:
	...
	struct FLinearColor                                CurrentColor;                                             // 0x023C(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FLinearColor                                StartColor;                                               // 0x024C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	...
	void SetColorAndSliders(const struct FLinearColor& Color);
