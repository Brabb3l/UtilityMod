...
#include "SF_Widget_PopupContentImageButton_parameters.hpp"
...
// Function Widget_PopupContentImageButton.Widget_PopupContentImageButton_C.PopulateCostSlots
// ()
// Parameters:
// TArray<struct FItemAmount>     Ingredients                    (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)

void UWidget_PopupContentImageButton_C::PopulateCostSlots(TArray<struct FItemAmount>* Ingredients)
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_PopupContentImageButton.Widget_PopupContentImageButton_C.PopulateCostSlots");

	UWidget_PopupContentImageButton_C_PopulateCostSlots_Params params;
