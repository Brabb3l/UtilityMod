...
#include "SF_Widget_CostSlotWrapper_parameters.hpp"
...
void UWidget_CostSlotWrapper_C::Setup_CostIcon(class UTexture* IconTexture, const struct FItemAmount& ItemAmount, class UFGInventoryComponent* CachedInventoryComponent, int SlotIdx, int CurrentNumInSlot, bool SmallSlot, bool BigSlot)
{
