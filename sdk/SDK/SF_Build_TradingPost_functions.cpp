...
#include "SF_Build_TradingPost_parameters.hpp"
...
ECompassRepresentationType ABuild_TradingPost_C::GetActorCompassRepresentationType()
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_TradingPost.Build_TradingPost_C.GetActorCompassRepresentationType");

	ABuild_TradingPost_C_GetActorCompassRepresentationType_Params params;
...
struct FLinearColor ABuild_TradingPost_C::GetActorCompassColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_TradingPost.Build_TradingPost_C.GetActorCompassColor");

	ABuild_TradingPost_C_GetActorCompassColor_Params params;
...
bool ABuild_TradingPost_C::GetActorShouldShowInComapss()
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_TradingPost.Build_TradingPost_C.GetActorShouldShowInComapss");

	ABuild_TradingPost_C_GetActorShouldShowInComapss_Params params;
...
struct FText ABuild_TradingPost_C::GetActorCompassText()
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_TradingPost.Build_TradingPost_C.GetActorCompassText");

	ABuild_TradingPost_C_GetActorCompassText_Params params;
...
class UTexture2D* ABuild_TradingPost_C::GetActorCompassTexture()
{
	static auto fn = UObject::FindObject<UFunction>("Function Build_TradingPost.Build_TradingPost_C.GetActorCompassTexture");

	ABuild_TradingPost_C_GetActorCompassTexture_Params params;
...
void ABuild_TradingPost_C::OnTradingPostUpgraded(int* Level)
{
