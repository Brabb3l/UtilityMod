...
#include "SF_BP_VehicleTargetPoint_parameters.hpp"
...
// Function BP_VehicleTargetPoint.BP_VehicleTargetPoint_C.IsTargetSpeedStill
// ()
// Parameters:
// bool                           wantsToIdle                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABP_VehicleTargetPoint_C::IsTargetSpeedStill(bool* wantsToIdle)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_VehicleTargetPoint.BP_VehicleTargetPoint_C.IsTargetSpeedStill");

	ABP_VehicleTargetPoint_C_IsTargetSpeedStill_Params params;
	...
	if (wantsToIdle != nullptr)
		*wantsToIdle = params.wantsToIdle;
}
