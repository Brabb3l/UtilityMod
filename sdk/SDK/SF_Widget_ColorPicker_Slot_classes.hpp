...
#include "SF_Widget_ColorPicker_Slot_structs.hpp"
...
public:
	...
	struct FVector2D                                   mSize;                                                    // 0x0240(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                mPrimaryColor;                                            // 0x0248(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	struct FLinearColor                                mSecondaryColor;                                          // 0x0258(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
