...
#include "SF_Widget_BuildMenu_CategoryButton_parameters.hpp"
...
// Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetTabArrowVisibility
// ()
// Parameters:
// ESlateVisibility               ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

ESlateVisibility UWidget_BuildMenu_CategoryButton_C::GetTabArrowVisibility()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetTabArrowVisibility");

	UWidget_BuildMenu_CategoryButton_C_GetTabArrowVisibility_Params params;
...
// Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetButtonColor
// ()
// Parameters:
// struct FLinearColor            ReturnValue                    (Parm, OutParm, ReturnParm, IsPlainOldData)

struct FLinearColor UWidget_BuildMenu_CategoryButton_C::GetButtonColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetButtonColor");

	UWidget_BuildMenu_CategoryButton_C_GetButtonColor_Params params;
...
// Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetCategoryIcon
// ()
// Parameters:
// struct FSlateBrush             ReturnValue                    (Parm, OutParm, ReturnParm)

struct FSlateBrush UWidget_BuildMenu_CategoryButton_C::GetCategoryIcon()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetCategoryIcon");

	UWidget_BuildMenu_CategoryButton_C_GetCategoryIcon_Params params;
...
// Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetCategoryName
// ()
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)

struct FText UWidget_BuildMenu_CategoryButton_C::GetCategoryName()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetCategoryName");

	UWidget_BuildMenu_CategoryButton_C_GetCategoryName_Params params;
...
// Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetTextColour
// ()
// Parameters:
// struct FSlateColor             ReturnValue                    (Parm, OutParm, ReturnParm)

struct FSlateColor UWidget_BuildMenu_CategoryButton_C::GetTextColour()
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_BuildMenu_CategoryButton.Widget_BuildMenu_CategoryButton_C.GetTextColour");

	UWidget_BuildMenu_CategoryButton_C_GetTextColour_Params params;
