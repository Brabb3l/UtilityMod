...
#include "SF_Tutorial_PowerSystem_Mail_structs.hpp"
...
// WidgetBlueprintGeneratedClass Tutorial_PowerSystem_Mail.Tutorial_PowerSystem_Mail_C
// 0x0028 (0x0288 - 0x0260)
class UTutorial_PowerSystem_Mail_C : public UFGMessageBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tutorial_PowerSystem_Mail.Tutorial_PowerSystem_Mail_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_Tutorial_PowerSystem_Mail(int EntryPoint);
};
