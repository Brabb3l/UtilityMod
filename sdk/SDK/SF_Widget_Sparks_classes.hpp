...
#include "SF_Widget_Sparks_structs.hpp"
...
public:
	...
	struct FVector2D                                   TargetPosition;                                           // 0x024C(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector2D                                   CurrentPosition;                                          // 0x025C(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector2D                                   SparkScale;                                               // 0x0278(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	...
	struct FVector2D                                   mMaxDistance;                                             // 0x0284(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
