...
#include "SF_Widget_Graph_structs.hpp"
...
public:
	...
	struct FVector2D                                   mAxisMax;                                                 // 0x0228(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   mCanvasSize;                                              // 0x0230(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   mScaler;                                                  // 0x0238(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
