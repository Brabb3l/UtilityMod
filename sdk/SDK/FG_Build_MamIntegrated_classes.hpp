...
public:
	...
	class UStaticMeshComponent*                        MainMesh_static;                                          // 0x0590(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBP_CrystalBuildingTradingComponent_C*       BP_CrystalBuildingTradingComponent;                       // 0x0598(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBP_CrystalFurnitureTradingComponent_C*      BP_CrystalFurnitureTradingComponent;                      // 0x05A0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FText                                       mOccupiedText;                                            // 0x05A8(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UCurveFloat*                                 mResearchMeshScale;                                       // 0x05C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
