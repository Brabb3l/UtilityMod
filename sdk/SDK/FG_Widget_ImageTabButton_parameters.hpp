...
#include "FG_Widget_ImageTabButton_classes.hpp"
...
struct UWidget_ImageTabButton_C_UpdateButtonStyle_Params
{
};

// Function Widget_ImageTabButton.Widget_ImageTabButton_C.CheckIsSelected
struct UWidget_ImageTabButton_C_CheckIsSelected_Params
{
	bool                                               isSelected;                                               // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};

// Function Widget_ImageTabButton.Widget_ImageTabButton_C.SetIcon
struct UWidget_ImageTabButton_C_SetIcon_Params
{
};
...
struct UWidget_ImageTabButton_C_PreConstruct_Params
{
	bool*                                              IsDesignTime;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Widget_ImageTabButton.Widget_ImageTabButton_C.Destruct
struct UWidget_ImageTabButton_C_Destruct_Params
{
};
