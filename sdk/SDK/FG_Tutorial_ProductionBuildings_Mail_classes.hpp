...
#include "FG_Tutorial_ProductionBuildings_Mail_structs.hpp"
...
// WidgetBlueprintGeneratedClass Tutorial_ProductionBuildings_Mail.Tutorial_ProductionBuildings_Mail_C
// 0x0028 (0x0288 - 0x0260)
class UTutorial_ProductionBuildings_Mail_C : public UFGMessageBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tutorial_ProductionBuildings_Mail.Tutorial_ProductionBuildings_Mail_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_Tutorial_ProductionBuildings_Mail(int EntryPoint);
};
