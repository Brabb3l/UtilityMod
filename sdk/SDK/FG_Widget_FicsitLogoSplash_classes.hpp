...
#include "FG_Widget_FicsitLogoSplash_structs.hpp"
...
// WidgetBlueprintGeneratedClass Widget_FicsitLogoSplash.Widget_FicsitLogoSplash_C
// 0x0040 (0x0248 - 0x0208)
class UWidget_FicsitLogoSplash_C : public UUserWidget
{
public:
	...
	class UWidget_LetterSpacedText_C*                  mName;                                                    // 0x0240(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Widget_FicsitLogoSplash.Widget_FicsitLogoSplash_C");
		return ptr;
	}


	void ShowLogo();
	void ExecuteUbergraph_Widget_FicsitLogoSplash(int EntryPoint);
};
