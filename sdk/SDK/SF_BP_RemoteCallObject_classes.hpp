...
#include "SF_BP_RemoteCallObject_structs.hpp"
...
public:
	...
	void Server_ResizeInventory(int newSize, class AFGCharacterPlayer* inCharacter);
	...
	void Client_AddPawnHUD(class UClass* HUDClass);
