...
#include "SF_BP_HUD_parameters.hpp"
...
// Function BP_HUD.BP_HUD_C.AddPawnHUD
// ()
// Parameters:
// class UClass*                  WidgetClass                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_HUD_C::AddPawnHUD(class UClass* WidgetClass)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HUD.BP_HUD_C.AddPawnHUD");

	ABP_HUD_C_AddPawnHUD_Params params;
	params.WidgetClass = WidgetClass;
