...
#include "SF_Widget_Options_parameters.hpp"
...
// Function Widget_Options.Widget_Options_C.ResolutionChangesAccepted
// ()
// Parameters:
// bool                           confirm                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UWidget_Options_C::ResolutionChangesAccepted(bool confirm)
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_Options.Widget_Options_C.ResolutionChangesAccepted");

	UWidget_Options_C_ResolutionChangesAccepted_Params params;
	params.confirm = confirm;
