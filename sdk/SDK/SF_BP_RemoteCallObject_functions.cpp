...
#include "SF_BP_RemoteCallObject_parameters.hpp"
...
void UBP_RemoteCallObject_C::Server_ResizeInventory(int newSize, class AFGCharacterPlayer* inCharacter)
{
...
void UBP_RemoteCallObject_C::Client_AddPawnHUD(class UClass* HUDClass)
{
