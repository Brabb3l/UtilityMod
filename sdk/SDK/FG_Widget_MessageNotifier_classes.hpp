...
#include "FG_Widget_MessageNotifier_structs.hpp"
...
public:
	...
	class UTextBlock*                                  mKeyShortcut;                                             // 0x0218(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	class UClass*                                      mMessage;                                                 // 0x0238(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FTimerHandle                                mTimerHandle;                                             // 0x0240(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       mText;                                                    // 0x0248(0x0028) (Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                               mActive;                                                  // 0x0260(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0261(0x0003) MISSED OFFSET
	float                                              mTimeToLive;                                              // 0x0264(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Widget_MessageNotifier.Widget_MessageNotifier_C");
		return ptr;
	}


	void GetKeyForAction(struct FText* keyText);
	void PreConstruct(bool* IsDesignTime);
	void Construct();
	void RemoveNotifier();
	void ExecuteUbergraph_Widget_MessageNotifier(int EntryPoint);
};
