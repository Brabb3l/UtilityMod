...
#include "SF_BP_Sky_Sphere_structs.hpp"
...
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x1458(0x0008) (Transient, DuplicateTransient)
	...
	struct FRotator                                    mOriginSunRotation;                                       // 0x148C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    mSunRotationAxis;                                         // 0x1498(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	...
	struct FRotator                                    mOriginMoonRotation;                                      // 0x14B8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    mMoonRotationAxis;                                        // 0x14C4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	...
	struct FFBrightnessAdjustment                      mSunBrightnessAdjust;                                     // 0x14D8(0x0008) (Edit, BlueprintVisible)
	struct FFBrightnessAdjustment                      mMoonBrightnessAdjust;                                    // 0x14E0(0x0008) (Edit, BlueprintVisible)
