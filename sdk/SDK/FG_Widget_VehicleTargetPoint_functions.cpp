...
#include "FG_Widget_VehicleTargetPoint_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_VehicleTargetPoint.Widget_VehicleTargetPoint_C.SetNewWaitTime");

	UWidget_VehicleTargetPoint_C_SetNewWaitTime_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_VehicleTargetPoint.Widget_VehicleTargetPoint_C.GetNodeTypeAndSetWindowTitle");

	UWidget_VehicleTargetPoint_C_GetNodeTypeAndSetWindowTitle_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_VehicleTargetPoint.Widget_VehicleTargetPoint_C.BndEvt__Widget_StandardButton_C_0_K2Node_ComponentBoundEvent_3_OnClicked__DelegateSignature");

	UWidget_VehicleTargetPoint_C_BndEvt__Widget_StandardButton_C_0_K2Node_ComponentBoundEvent_3_OnClicked__DelegateSignature_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_VehicleTargetPoint.Widget_VehicleTargetPoint_C.BndEvt__mDeleteButton2_K2Node_ComponentBoundEvent_5_OnClicked__DelegateSignature");

	UWidget_VehicleTargetPoint_C_BndEvt__mDeleteButton2_K2Node_ComponentBoundEvent_5_OnClicked__DelegateSignature_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_VehicleTargetPoint.Widget_VehicleTargetPoint_C.BndEvt__mWaitButton_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature");

	UWidget_VehicleTargetPoint_C_BndEvt__mWaitButton_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature_Params params;
...
void UWidget_VehicleTargetPoint_C::SetWaitTimePopup(bool mPopUpConfirm)
{
	...
	UWidget_VehicleTargetPoint_C_SetWaitTimePopup_Params params;
	params.mPopUpConfirm = mPopUpConfirm;
...
void UWidget_VehicleTargetPoint_C::BndEvt__Widget_InputBox_K2Node_ComponentBoundEvent_6_OnTextComitted__DelegateSignature(const struct FText& Text, TEnumAsByte<ETextCommit> CommitMethod)
{
	...
	UWidget_VehicleTargetPoint_C_BndEvt__Widget_InputBox_K2Node_ComponentBoundEvent_6_OnTextComitted__DelegateSignature_Params params;
	params.Text = Text;
...
void UWidget_VehicleTargetPoint_C::PreConstruct(bool* IsDesignTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function Widget_VehicleTargetPoint.Widget_VehicleTargetPoint_C.PreConstruct");

	UWidget_VehicleTargetPoint_C_PreConstruct_Params params;
