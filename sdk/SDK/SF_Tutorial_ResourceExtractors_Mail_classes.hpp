...
#include "SF_Tutorial_ResourceExtractors_Mail_structs.hpp"
...
// WidgetBlueprintGeneratedClass Tutorial_ResourceExtractors_Mail.Tutorial_ResourceExtractors_Mail_C
// 0x0028 (0x0288 - 0x0260)
class UTutorial_ResourceExtractors_Mail_C : public UFGMessageBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass Tutorial_ResourceExtractors_Mail.Tutorial_ResourceExtractors_Mail_C");
		return ptr;
	}


	void Construct();
	void ExecuteUbergraph_Tutorial_ResourceExtractors_Mail(int EntryPoint);
};
