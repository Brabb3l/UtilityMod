...
#include "SF_BP_DeathMarker_parameters.hpp"
...
ECompassRepresentationType ABP_DeathMarker_C::GetActorCompassRepresentationType()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathMarker.BP_DeathMarker_C.GetActorCompassRepresentationType");

	ABP_DeathMarker_C_GetActorCompassRepresentationType_Params params;
...
struct FLinearColor ABP_DeathMarker_C::GetActorCompassColor()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathMarker.BP_DeathMarker_C.GetActorCompassColor");

	ABP_DeathMarker_C_GetActorCompassColor_Params params;
...
struct FText ABP_DeathMarker_C::GetActorCompassText()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathMarker.BP_DeathMarker_C.GetActorCompassText");

	ABP_DeathMarker_C_GetActorCompassText_Params params;
...
class UTexture2D* ABP_DeathMarker_C::GetActorCompassTexture()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathMarker.BP_DeathMarker_C.GetActorCompassTexture");

	ABP_DeathMarker_C_GetActorCompassTexture_Params params;
...
bool ABP_DeathMarker_C::GetActorShouldShowInComapss()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DeathMarker.BP_DeathMarker_C.GetActorShouldShowInComapss");

	ABP_DeathMarker_C_GetActorShouldShowInComapss_Params params;
